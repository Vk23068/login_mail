...
function Registration() {
    ...
    function handleFormSubmit(e) {
        ...
        if (!name || !email || !password || !phone || !profession) {
            ...
            setFlag(false);
            localStorage.setItem("vishalSubmissionEmail", JSON.stringify(email));
            localStorage.setItem("vishalSubmissionPassword", JSON.stringify(password));
        ...
        <>
            {/* <nav className="navbar navbar-light">
                <div className="container" onClick={infoClick}>
                    <h4 className="btn btn-dark btn-lg btn-block">Login</h4>
                </div>
            </nav> */}
            {info ? <div> {login ?
             ...
             <form className='container' onSubmit={handleFormSubmit}>
                ...
                <p className="forgot-password text-right">
                    Already registered <div className="container" onClick={infoClick}>
                    <h4 className="btn btn-dark btn-lg btn-block">Login</h4>
                </div>
                </p>
                {flag &&
